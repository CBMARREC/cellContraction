...
initial_shear = 0.1 # this is tan theta (theata is the angle between the lateral side at the beginning and the same side at the end)
...
step_length = 0.001 # Shear right and deshear left will happen in small steps. Shear for step N+1 has shear of step N as initial guess

print_Niter = 1

resolution = 7

uc0 = -0.00 # uniform radial displacement, - gives contraction, + gives expansion 
...
c1_x, c1_y, i_rho1 = 0.5, 0.5, 0.14    # center and radius of a cell
